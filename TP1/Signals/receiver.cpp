...
{
    std::cout << "\nHi, you've just activated my first function because you raised " << SIGUSR1 << ", nice!\n";
}

void handle_usr_signal2()
{
    std::cout << "\nThis is my second function. I honestly don't know what to do here but it's the intention that counts\n";
}

void handle_interrupt()
{
    std::cout << "\nOooohh, so you want to terminate me, hm? whyyy\n";
    exit(1);
}
